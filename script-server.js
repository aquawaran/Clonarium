...
function createPostElement(post) {
    ...
    const authorId = post.author_id || post.authorId || post.user_id || post.userId || post.author?.id || '';
    ...
    const avatarHtml = avatarSrc 
        ? `<img src="${avatarSrc}" alt="${authorName}" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
...
async function loadUserPosts() {
    ...
    return loadUserPostsById(app.currentUser.id);
}
